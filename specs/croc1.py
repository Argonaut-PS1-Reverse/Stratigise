...
"""
def processHeaders(strat, instructions):
	size = strat.readInt32LE()
	audio_upper = strat.readInt16LE()
	audio_start = strat.readInt16LE()
	
	instructions.setPreamble(f"; This file has been automatically generated by Stratigise, which is not meant for\n; modding at the moment.\n\n@original_strat_size {size}\n@original_audio_start {audio_start}\n@audio_higher_bytes {audio_upper}\n\n")
	
	return [size, audio_upper, audio_start]
